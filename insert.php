<?php
    ...
    if(isset($_POST['insert'])){
        ...
        $sql = "INSERT INTO record_fields(Tracking_number, Title, Types, Origin, Dates, Destination, Tags) VALUES (:track, :tit, :typ, :ori, :dat, :des, :tag)";
...
<body>
    ...
    <form name="insertrecord" method="POST">
        ...
        <div class="row">
            <div class="col-md-6">
                <b> Date Recieved</b>
                <input type="date" name="dates" placeholder="Select Date" class="form-control" required >
            </div>
